...
import { createChunkOptions, splitWordIntoChunks } from './chunking'
...
export type StudyQuestion = ChoiceQuestion | SpellingQuestion | ReadAloudQuestion
...
export const createQuestion = ({
  ...
  if (questionType === 'spelling') {
    return {
      ...
      answer: word.text,
      answerChunks: splitWordIntoChunks(word.text),
      chunkOptions: createChunkOptions(word.text, word.id),
    }
  }
